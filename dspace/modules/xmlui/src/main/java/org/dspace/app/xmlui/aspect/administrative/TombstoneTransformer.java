...
//        Composite addComposite = fields.addItem().addComposite("subject");
//        addComposite.setLabel(T_subject);
//        Text subject = addComposite.addText("subject");
//
//        addComposite = fields.addItem().addComposite("message");
//        addComposite.setLabel(T_message);
//        TextArea addValue = addComposite.addTextArea("message");
