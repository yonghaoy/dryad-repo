 ...
 */
@Component
public class HandleIdentifierService implements DSpaceIdentifierService {
    /** log4j category */
    private static Logger log = Logger.getLogger(HandleIdentifierService.class);


    public String register(Context context, DSpaceObject dso) {
        return mint(context, dso);  //To change body of implemented methods use File | Settings | File Templates.
    }
